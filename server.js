...
const myRooms = [
  {
    ...
    roomName: "luxury_1",
    seats_available: 25,
    amenities: ["TV", "Refrigirator", "AC", "Internet"],
    price: 7500,
    room_booking_status: [
      {
        booking_status: "booking complete",
        cust_name: "Customer_1",
        date_booked: new Date("2023-09-11"),
        start_time: "07:00",
        end_time: "23:00",
      },
    ],
  },
  {
    ...
    roomName: "luxury_2",
    seats_available: 50,
    amenities: ["TV", "Refrigirator", "Non-AC", "Internet"],
    price: 5000,
    room_booking_status: [
      {
        booking_status: "booking complete",
        cust_name: "Customer_2",
        date_booked: "2023-10-18",
        start_time: "09:00",
        end_time: "22:00",
      },
    ],
  },
  {
    ...
    roomName: "luxury_3",
    seats_available: 10,
    amenities: ["Refrigirator", "AC", "Internet"],
    price: 5000,
    room_booking_status: [
      {
        booking_status: "booking complete",
        cust_name: "Customer_3",
...
// home page
app.get("/", (req, res) => {
  res.send(`Welcome to Hall Booking Api <br/>
  EndPoints: <br/>
 "/createroom", "/bookroom", "/getrooms", "/getcustomers"`);
});

// create a new room service
app.post("/createroom", (req, res) => {
  let myNewRoom = {
    roomID: "RM" + req.body.roomID,
